...
impl<Item> List for Vec<Item> {
    ...
    fn insert(&mut self, index: usize, items: impl Iterator<Item = Item>) {
        Vec::splice(self, index..index, items);
    }
...
mod tests {
    ...
    fn inserting_items_before_the_first_item() {
        ...
        assert_eq!(items, vec![6, 7, 8, 1, 2, 3, 4, 5]);
    }
    ...
    fn inserting_items_before_the_last_item() {
        ...
        assert_eq!(items, vec![1, 2, 3, 4, 6, 7, 8, 5]);
    }
    ...
    fn inserting_items_after_the_first_item() {
        ...
        assert_eq!(items, vec![1, 6, 7, 8, 2, 3, 4, 5]);
    }
